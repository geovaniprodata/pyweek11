...
def empresa(request, id):
    ...
    if empresa.user != request.user:
        messages.add_message(request, constants.ERROR, 'Esta empresa não lhe pertence.')
    ...
    if request.method == 'GET':
        ...
        return render(request, 'empresa.html', {'empresa': empresa, 'documentos': documentos, 'pi_enviadas' : propostas_investimentos_enviada, 'perc_vendido': int(percentual_vendido), 'total_captado': total_captado, 'valuation_atual': valuation_atual})
